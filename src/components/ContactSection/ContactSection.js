    ...
    <section id="contact" className={styles.section}>
      <div className={styles.contentWrapper}>
        <div className={styles.contactInfoBlock}>
          ...
          <div className={styles.infoGrid}>
            <div className={styles.infoBlock}>
              ...
              <a href="mailto:anggadev07@gmail.com" className={styles.infoValue}>anggadev07@gmail.com</a>
            </div>
            <div className={styles.infoBlock}>
        ...
        <div className={styles.socialsContainer}>
          ...
          <a href="https://www.linkedin.com/in/dewangga-fadillah-yusuf/" target="_blank" rel="noopener noreferrer" className={styles.socialLink}>
